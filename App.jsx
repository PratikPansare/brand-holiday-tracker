...
export default function App() {
  ...
  const fetchHolidays = async () => {
    ...
    try {
      ...
      // Step 1: Try scraping nationaltoday.com via CORS proxy
      let allHolidays = []
      try {
      ...
      // If scraping returned nothing (proxies blocked/failed), use built-in database
      if (allHolidays.length === 0) {
        setFetchProgress('Web scraping unavailable — using built-in holiday database...')
